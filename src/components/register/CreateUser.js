...
class CreateUser extends React.Component {
  ...
  createUserSubmit = () => {
    if(!this.state.firstName || !this.state.lastName || !this.state.email || !this.state.password) {
      NotificationManager.warning('error', "Please fill required details", 3000);
  ...
  render() {
    ...
    return (
      <div>
        ...
        <FormControl aria-describedby="enter email" error ={this.state.validEmail} className={classes.formControl}>
          ...
          <FormHelperText id="email-error-text">Enter email ending with <b>{constants.emailDomain}</b></FormHelperText>
          :''}
        </FormControl>
        <FormControl aria-describedby="enter password" error ={!this.state.validpassword} className={classes.formControl}>
          ...
          />
          {!this.state.password?
          <FormHelperText id="password-error-text">Enter Password</FormHelperText> : ''}
        </FormControl>


        <span>
          <Button color="primary" variant="contained" component="span" className={classes.button} onClick={this.createUserSubmit} >
            Sign Up
          </Button>
          <Button color="secondary" variant="outlined" component="span" className={classes.button}>
             return to login
          </Button>
        </span>
